				...
				<div className="container">
					<div className="row">
						<div className="col-md-6 white-text text-center text-md-left mt-5 mb-5">
							<h1 className="h1-responsive font-weight-bold mt-5">
								One plot, <br /> infinite stories
							</h1>
					...
					<div className="row align-items-stretch">
						...
						<HomeServiceCard
							...
							text="Build your own characters from scratch and always revisit to add new details about their past, present and future story."
